...
describe('Cluster', () => {
  ...
  //     cy.get(
  //       ':nth-child(2) > .MuiPaper-outlined > .information_cidrsTags__4sKxa > .information_cidrWrapper__wLuys > :nth-child(4)',
  //     )
  //       .should('be.visible')
  //       .and('have.text', 'Xiamen');
  //     // cy.get(
  //     //   ':nth-child(2) > .MuiPaper-outlined > .information_cidrsTags__4sKxa > .information_cidrWrapper__wLuys > :nth-child(5)',
  //     // ).should('not.be.visible');
  ...
  //   });
  //   it('the visible width of the screen is 2560px. Display scopes', () => {
  //     cy.viewport(2560, 1080);
  //     // The number of idc displayed is 5.
  //     cy.get(
  //       ':nth-child(2) > .information_cidrsContainer__joiB7 > .information_cidrsTags__4sKxa > .information_cidrWrapper__wLuys > :nth-child(1)',
  //     )
  //       .should('be.visible')
  ...
  //       .should('be.visible')
  //       .and('have.text', 'Xiamen');
  //     cy.get('.information_cidrWrapper__wLuys > :nth-child(5)').should('be.visible').and('have.text', 'Nanchang');
  //     // The number of CIDRs displayed is 4.
  //     cy.get(
  //       ':nth-child(3) > .information_cidrsContainer__joiB7 > .information_cidrsTags__4sKxa > .information_cidrWrapper__wLuys > :nth-child(1)',
  //     ).should('have.text', '10.0.0.0/8');
