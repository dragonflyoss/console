...
describe('Scheduler', () => {
  ...
  it('Scheduler', () => {
    ...
    cy.get('.show_schedulerContainer__euX4O > :nth-child(3)')
      ...
      .and('contain', 'Preheat');
    cy.get('.show_schedulerContainer__euX4O > :nth-child(4)').should('be.visible').and('contain', '2023-11-09-15:09');
    cy.get('.show_schedulerContainer__euX4O > :nth-child(5)').should('be.visible').and('contain', '2023-11-09-15:09');
  });
