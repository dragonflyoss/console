...
describe('SeedPeer', () => {
  ...
  it('SeedPeer', () => {
    ...
    cy.get('.show_seedPeerContainer__X4hKN > :nth-child(6)').should('be.visible').and('contain', '2023-11-12-04:09');
    cy.get('.show_seedPeerContainer__X4hKN > :nth-child(7)').should('be.visible').and('contain', '2023-11-12-04:09');
  });
