...
describe('Show cluster', () => {
  ...
  it('Delete scheduler', () => {
    ...
    cy.get('.MuiAlert-message').scrollIntoView().should('have.text', 'Submission successful!').should('be.visible');
  ...
  it('Failed to delete scheduler', () => {
    ...
    cy.get('#deleteScheduler').click();
    cy.get('.MuiAlert-message').scrollIntoView().should('have.text', 'Unauthorized').should('be.visible');
  });
  ...
  it('Role guest delete scheduler', () => {
    ...
    cy.get('#deleteScheduler').click();
    cy.get('.MuiAlert-message').scrollIntoView().should('have.text', 'permission deny').should('be.visible');
  });
