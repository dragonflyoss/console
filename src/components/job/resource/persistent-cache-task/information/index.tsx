...
import { ReactComponent as PieceLength } from '../../../../../assets/images/job/resource/persistent-cache-task/piece-length.svg';
import { ReactComponent as ContentLength } from '../../../../../assets/images/job/resource/persistent-cache-task/content-length.svg';
import { ReactComponent as TotalPieceLength } from '../../../../../assets/images/job/resource/persistent-cache-task/total-piece-length.svg';
import { ReactComponent as CotentLength } from '../../../../../assets/images/job/resource/persistent-cache-task/content-length.svg';
...
import { DataContext } from '../../persistent-cache-task';
...
export default function Information(props: InformationProps) {
  ...
  return (
    <Box>
          ...
          <Box className={styles.navigationContent}>
            <Box>
              ...
              <Box className={styles.navigationCount}>
                ...
                <Typography variant="body2" color="var(--palette-table-title-text-color)">
                  number of successful persistent cache task
                </Typography>
              </Box>
            </Box>
            <Box className={styles.navigation} />
          ...
          <Box className={styles.navigationContent}>
            <Box>
              ...
              <Box className={styles.navigationCount}>
                ...
                <Typography variant="body2" color="var(--palette-table-title-text-color)">
                  number of application persistent cache task
                </Typography>
              </Box>
            </Box>
            <Box className={styles.navigation} />
      ...
      <Stack spacing={2} sx={{ width: '20rem', mb: '2rem' }}>
        <Autocomplete
          size="small"
          color="secondary"
          id="free-solo-demo"
              ...
              <Card className={styles.card}>
                <Box p="1.2rem" position="relative">
                  ...
                  <MuiTooltip title={item.id || '-'} placement="top">
                    <RouterLink
                      component={Link}
                      to={`/jobs/resource/persistent-cache-task/${item?.id}`}
                      underline="hover"
                    >
                      <Typography
